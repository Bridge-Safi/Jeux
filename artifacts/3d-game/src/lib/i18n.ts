...
const DICT: Record<Lang, Record<string, string>> = {
  ...
  fr: {
    ...
    "rules.collect.l1": "Objectif : récolter 15 000 💎 en 3 jours",
    ...
    "rules.bonus.l1": "Jouez 1h DE PLUS que votre session normale (3h)",
    ...
    "bridge.how.duration": "⏱️ Joue 3h par jour pendant 3 jours consécutifs (9h min total)",
    "bridge.how.rate": "💎 Récolte 1 000 💎 par heure — objectif 15 000 💎",
    "bridge.how.shortfall": "💰 Diamants manquants ? 1 000 💎 = 5 DH",
    "bridge.how.bonus": "🎁 Bonus : joue 1h DE PLUS → +2 000 💎 + livraison 100% GRATUITE",
    ...
    "auth.manual.toggle": "Déjà inscrit sur Bridge Eats ? Entre juste ton numéro",
    "auth.manual.title": "Ton n° de téléphone Bridge Eats",
    ...
    "instr.how.play": "Joue 3h par jour pendant {d} jours CONSÉCUTIFS",
    ...
    "instr.how.bonus": "🎁 Bonus : joue 1h DE PLUS → +2 000 💎 + livraison 100% GRATUITE",
  ...
  en: {
    ...
    "rules.collect.l1": "Goal: collect 15,000 💎 in 3 days",
    ...
    "rules.bonus.l1": "Play 1h MORE than your normal session (3h)",
    "rules.bonus.l2": "→ Your next delivery is 100% FREE 🎁",
    "rules.bonus.l3": "→ You also earn +2,000 💎 bonus!",

    "bridge.how.duration": "⏱️ Play 3h per day for 3 consecutive days (9h min total)",
    "bridge.how.rate": "💎 Collect 1,000 💎 per hour — goal 15,000 💎",
    "bridge.how.shortfall": "💰 Missing diamonds? 1,000 💎 = 5 DH",
    "bridge.how.bonus": "🎁 Bonus: play 1h MORE → +2,000 💎 + 100% FREE delivery",
    ...
    "auth.manual.toggle": "Already on Bridge Eats? Just enter your phone",
    "auth.manual.title": "Your Bridge Eats phone number",
    ...
    "instr.how.play": "Play 3h per day for {d} CONSECUTIVE days",
    ...
    "instr.how.bonus": "🎁 Bonus: play 1h MORE → +2,000 💎 + 100% FREE delivery",
  ...
  ar: {
    ...
    "rules.collect.l1": "الهدف: جمع 15000 💎 في 3 أيام",
    ...
    "rules.bonus.l1": "العب ساعة إضافية عن جلستك العادية (3 ساعات)",
    "rules.bonus.l2": "← توصيلتك القادمة مجانية 100% 🎁",
    "rules.bonus.l3": "← تربح أيضاً +2000 💎 مكافأة!",

    "bridge.how.duration": "⏱️ العب 3 ساعات يومياً لمدة 3 أيام متتالية (9 ساعات على الأقل)",
    "bridge.how.rate": "💎 اجمع 1000 💎 في الساعة — الهدف 15000 💎",
    "bridge.how.shortfall": "💰 ينقصك ألماس؟ 1000 💎 = 5 درهم",
    "bridge.how.bonus": "🎁 مكافأة: العب ساعة إضافية → +2000 💎 + توصيل مجاني 100%",
    ...
    "instr.how.play": "العب 3 ساعات يومياً لمدة {d} أيام متتالية",
    ...
    "instr.how.bonus": "🎁 مكافأة: العب ساعة إضافية → +2000 💎 + توصيل مجاني 100%",
